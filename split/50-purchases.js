        ...
        <div class="bd">
          <div style="max-height:52vh; overflow:auto">
            <table class="table small">
              <thead><tr><th>Code</th><th>Name</th><th class="r">Avg Cost</th><th class="r">On Hand</th><th class="r" style="width:120px">Qty</th><th class="r" style="width:90px"></th></tr></thead>
  ...
  async function openItemPicker({ onPick, prefill = "" } = {}) {
    ...
    const render = async (needle = "") => {
      ...
      rows.querySelectorAll("tr[data-id]").forEach(tr => {
        ...
        tr.querySelector("[data-add]").onclick = () => {
